...
function deathOrGlory()
{
	if ((rival.pv <= 0) && (player.pv <=0))
	{
		...
		infoTextDown.textContent = "Clics on the bubble above or refresh the page(mobile) to clean your honor";
			...
			if (player.pv >= 60){
				...
				infoTextUp.textContent ='Kame Sennin : \"I have the high ground\"';
